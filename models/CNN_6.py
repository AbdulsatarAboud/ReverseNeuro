...
class Network(nn.Module):
    def __init__(self, num_classes):
        ...
        self.fc7 = nn.Linear(in_features=9100, out_features=6144) # fillin the appropriate number of input channels = 100xL*W of previous layer

        self.fc8 = nn.Linear(in_features=6144, out_features=3000)

        self.fc9 = nn.Linear(in_features=3000, out_features=1000)
        
        self.fc10 = nn.Linear(in_features=1000, out_features=500)

        self.fc11 = nn.Linear(in_features=500, out_features=100)

        self.fc12 = nn.Linear(in_features=100, out_features=num_classes)

        self.softmax13 = nn.Softmax()
